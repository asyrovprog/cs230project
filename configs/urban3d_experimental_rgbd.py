...
class Urban3dExperimentalRGBD(Config):
    ...
    NAME = "urban3d_experimental_rgbd"
    ...
    LEARNING_RATES  = [LEARNING_RATE / 10]
    LEARNING_LAYERS = ["all"]
    LEARNING_EPOCHS = [100]
...
class Urban3dExperimentalRGBDInference(Urban3dExperimentalRGBD):
    GPU_COUNT = 1
    IMAGES_PER_GPU = 1
