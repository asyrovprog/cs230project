...
class Urban3dExperiment(Config):
    """Configuration for training on MS COCO.
    Derives from the base Config class and overrides values specific
    to the COCO dataset.
    """
    # Give the configuration a recognizable name
    NAME = "urban3d_experiment"
    ...
    LEARNING_RATE = 0.001
    LEARNING_RATES = [LEARNING_RATE / 10, LEARNING_RATE, LEARNING_RATE / 100, LEARNING_RATE / 10]
    LEARNING_LAYERS = ["heads", "heads", "all", "all"]
    LEARNING_EPOCHS = [1, 2, 3, 6]
...
class Urban3dExperimentInference(Urban3dExperiment):
    GPU_COUNT = 1
    IMAGES_PER_GPU = 1